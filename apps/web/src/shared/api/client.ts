...
/**
 * Мост к auth-состоянию. Реализуется Pinia-стором в рантайме, но клиент
 * зависит только от интерфейса — это держит его тестируемым без Pinia.
 */
...
export class ApiClient {
  ...
  /** Привязка к auth-стору после создания Pinia. */
